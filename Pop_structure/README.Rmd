...
NB : I removed the outgroup, since it doesn't make sense to keep *P. vivax-like* samples.
...
Ancestry plots are inferred with PCAngsd and the input file is the same as for PCA.

According to [Meisner and Albrechtsen](10.1534/genetics.118.30133), the best K is determined by 1+ D (the optimal number of principal components). As presented in Supplementary Fig. 4 in the paper, D would be equal to 5 (determined by the elbow (broken-stick) method), so K=6.
...
Version: [vcf2phylip v2.0](https://doi.org/10.5281/zenodo.2540861), python v2.7.5, iqtree v2.0.3, bcftools v1.10.2.
